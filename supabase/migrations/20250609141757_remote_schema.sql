...
CREATE POLICY "Users can manage their own exercise sets" ON "public"."exercise_sets" TO "authenticated" USING (("auth"."uid"() = ( SELECT "workout_exercises"."user_id"
   FROM "public"."workout_exercises"
  WHERE ("workout_exercises"."id" = "exercise_sets"."workout_exercise_id")))) WITH CHECK (("auth"."uid"() = ( SELECT "workout_exercises"."user_id"
   FROM "public"."workout_exercises"
